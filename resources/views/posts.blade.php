...
@if ($posts->count())
    ...
    <div class="card">
        <div class="card-body text-center">
            ...
            <img src="https://source.unsplash.com/1450x500?{{ $posts[0]->category->name }}" class="card-img-bottom" alt="{{ $posts[0]->category->name }}">
    ...
    <div class="row">
        @foreach ($posts->skip(1) as $post)
            <div class="col-md-4 mb-3">
                <div class="card">
                    <div class="position-absolute text-white"><a href="/posts?category={{ $post->category->slug }}" class="text-white text-decoration-none">{{ $post->category->name }}</a></div>
                    <img src="https://source.unsplash.com/600x500?{{ $post->category->name }}" class="card-img-top" alt="{{ $post->category->name }}">
                    <div class="card-body">
